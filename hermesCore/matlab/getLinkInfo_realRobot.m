function links = getLinkInfo
 ...
 % links{BASE}.mass = 7.1448;
  links{BASE}.mass = 11.1448; %added 4 kg
  links{BASE}.com = [-0.020963; -0.010211; 0.19435]; %moved in the back by 9 cm
  ...
  links{B_TFE}.mass = 3.93 %taken from page 1 of TFE minus 1 kg
  ...
  links{L_EP}.rotation = R(0,0,pi/2);
