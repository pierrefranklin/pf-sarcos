...
//	  update_base_state_estimation(&base_orient, &base_state);
  ...
  //get raw data from motor servo
  raw_data.get_from_sm(raw_joint_state, raw_misc_sensor);
